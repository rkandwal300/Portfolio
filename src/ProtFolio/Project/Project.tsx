...
const Project = () => {
    ...
    <div id='Work' className=' w-[94%]    h-fit mb-[120px] mt-[100px]  flex flex-col justify-start  items-start    '>
            <div className=' h-fit  w-full flex flex-col justify-center items-start cursor-default '>
    
                
                <div className=' flex   w-full flex-row justify-center items-center mb-[50px]  '>
                    <div className='sm:text-[32px] text-[20px] fontF flex  flex-row justify-start items-center  ' > <span className='textC  text-xl mr-3 '> 03.</span>
                    <span style={{ color: 'rgb(200,210,242)', }}  className='text-gray-300 font-bold   '> Some Things I’ve Built</span> </div>
                    <div className='border-t-2 h-1 ml-3 sm:w-[30%]  w-[40px] border-gray-500   sm:block '> </div>
                </div>
            <div className=' w-[90%] h-fit grid  md:grid-cols-2 xl:grid-cols-3  grid-cols-1    '>
                {/* <ProjectDetail /> */}
                {
