  ...
  return (
    <div className='h-fit  fixed z-50 top-0  back w-full  text-white flex justify-between py-4   px-6'>
        ...
        <nav className= {' sm:w-fit sm:h-fit absolute  top-0 left-0 sm:relative sm:top-0 sm:left-0 h-full flex w-full  flex-row justify-between   transition-all  duration-500   '  + (hide? '  top-[0px] '  : ' left-[800px] ' ) }>
            ...
            <div className={' w-[20%] h-screen sm:w-fit  sm:h-fit   bg-slate-300/20 ' + (hide? ' ' : ' h-0') }  onClick={Handlemenu}></div>
            ...
            <ul className= {'h-screen sm:h-fit    sm:mt-2 sm:justify-evenly sm:items-center w-[80%]  sm:w-fit back  flex flex-col sm:flex-row   justify-evenly items-center  sm:text-[13px]  sm:font-[400] fontF  py-[150px] sm:py-0  '}  >
              {hide?  (<li className=' flex flex-row justify-between items-start  h-fit w-full px-[10%] sm:hidden relative top-[-27%] '> 
                    <div></div>
                <div className=' text-xl textC  '  onClick={Handlemenu}> <MdOutlineCancel className=' text-3xl' /> </div>
                </li>):(<li></li>)}

                <Link  to= 'Home' spy={true} smooth={true} offset={-120} duration={500} >

                <li  className='flex  sm:text-[14px]  font-semibold sm:mx-4 justify-center items-center flex-row mb-1 sm:mb-0'>
                ...
                <li  className='flex  sm:text-[14px] font-semibold sm:mx-4 justify-center items-center flex-row  mr-3  mb-1 sm:mb-0'>
                ...
                <li  className='flex  sm:text-[14px] font-semibold sm:mx-4 justify-center items-center flex-row mr-3   my-2 sm:my-0'>
                ...
                <li className=' mt-5  sm:text-[14px] font-semibold sm:mx-4 mb-8 sm:mb-0 sm:mt-0 ' >  
