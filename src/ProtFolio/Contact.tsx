...
const Contact = () => {
    ...
    <div id='Contact' className='w-[90%] h-[70vh]  flex  flex-col  justify-start items-center  '>
        ...
        <a href='mailto:rahulkandwal707@gmail.com' rel="noopener noreferrer" target={'_blank'} className=' h-[56px] w-[231px]  fontF text-[14px] textC borderB ResH   rounded-md my-[30px] mb-[50px] grid justify-items-center items-center '>    Say Hello</a>
